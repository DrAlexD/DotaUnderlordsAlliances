public enum Hero {
    /*21) Тролль(4) Чернокнижник(3) Целитель(3) Дикарь(2) ОднойКрови(2) Рыцарь(2) Друид(2) Шаман(2) Демон(1) :Веник, Бладсикер, Бэтрайдер, Энча, Варлок, Шаман, Дазл, ВитчДоктор, Фурион, Чаос,
21) Тролль(4) Чернокнижник(3) Целитель(3) Дикарь(2) Рыцарь(2) ОднойКрови(2) Друид(2) Шаман(2) Демон(1) :Веник, Бэтрайдер, ОгрМаг, Энча, Варлок, Шаман, Дазл, ВитчДоктор, Фурион, Чаос, */
    ...
    Aбадон(HeroClass.Бессердечный, HeroClass.Рыцарь),
